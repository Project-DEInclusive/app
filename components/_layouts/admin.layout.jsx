...
import { LogoLong, LogoIcon } from "../../constants/images";
    ...
    return (
        <>
            <div>
                                ...
                                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white">
                                    ...
                                    <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4">
                                        <div className="flex flex-shrink-0 items-center justify-center px-4" onClick={() => router.push("/")}>
                                            <img className="h-8 w-auto" src={LogoLong.src} alt="Workflow" />
                                        </div>
                                            ...
                                            <div className="flex items-center">
                                                <div>
                                                    <img
                                                        ...
                                                        src={user.value ? `${process.env.NEXT_PUBLIC_IMAGE_URL}${user.value?.id}?key=${user.value?.thumbnail?.src}` : ""}
                ...
                <div className={`hidden md:fixed md:inset-y-0 md:flex md:flex-col ${sidebarCollapse ? "w-16 hover:w-64 hover:shadow-xl z-10" : "md:w-64"}`}>
                    <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
                        <div className="flex flex-1 flex-col overflow-x-hidden pt-5 pb-4">
                            <div className="flex flex-shrink-0 items-center justify-center px-4">
                                <img className="h-8 w-auto" src={sidebarCollapse ? LogoIcon.src : LogoLong.src} alt="Workflow" onClick={() => router.push("/")} />
                                {sidebarCollapse ? (
                                    <ArrowRightIcon
                            ...
                            <nav className="mt-8 flex-1 space-y-1 bg-white px-2 overflow-y-auto overflow-x-hidden" aria-label="Sidebar">
                                {navigation.map((item) =>
                                    !item.children || item.children.length == 0 ? (
                                        <div key={item.name}>
                                            <a
                ...
                <div className={`flex flex-1 flex-col ${sidebarCollapse ? "md:pl-16" : "md:pl-64"}`}>
                    <div className="absolute top-0 right-0 z-10 bg-white pl-1 pt-1 sm:pl-3 sm:pt-3 md:hidden">
                        <button
                            type="button"
                            className="mr-3 inline-flex mt-3 h-12 w-12 items-center justify-center rounded-md text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
                        ...
                        <div className="bg-white min-h-full px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
                            <div className="max-w-max mx-auto">
                                <main className="sm:flex">
                                    <p className="text-4xl tracking-tight font-bold text-indigo-600 sm:text-5xl sm:tracking-tight">401</p>
                                    <div className="sm:ml-6">
                                        <div className="sm:border-l sm:border-gray-200 sm:pl-6">
                                            <h1 className="text-4xl font-bold text-gray-900 tracking-tight sm:text-5xl sm:tracking-tight">Unauthorized!</h1>
                                        ...
                                        <div className="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
                                            ...
                                            <Link href="/auth/signin">
                                                <div className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                                    Sign In
                                                </div>
                                            </Link>
                                        </div>
