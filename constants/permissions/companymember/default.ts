...
// Set create permissions for the 'companymember' collection for the 'Default' role
const createPermission = new CActionPermission("create");
createPermission.allowed = false;

// Set read permissions for the 'companymember' collection for the 'Default' role
const readPermission = new CActionPermission("read");
readPermission.allowed = false;

// Set update permissions for the 'companymember' collection for the 'Default' role
const updatePermission = new CActionPermission("update");
updatePermission.allowed = false;

// Set delete permissions for the 'companymember' collection for the 'Default' role
