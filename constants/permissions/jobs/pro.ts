...
// Set create permissions for the 'jobs' collection for the 'Verified' role
const createPermission = new CActionPermission("create");
createPermission.allowed = true;
createPermission.immutableprops = ["_id", "owner", "status", "featured", "draft", "quality", "deleted"]; // Define the properties that can't be updated by 'Verified' role
createPermission.hiddenprops = ["__v", "owner"]; // Define the properties dont't need send  to the client

// Set read permissions for the 'jobs' collection for the 'Verified' role
const readPermission = new CActionPermission("read");
readPermission.allowed = true;
readPermission.immutableprops = ["_id", "owner", "status", "featured", "draft", "quality", "deleted"]; // Define the properties that can't be updated by 'Verified' role
...
// Set update permissions for the 'jobs' collection for the 'Verified' role
const updatePermission = new CActionPermission("update");
updatePermission.allowed = true;
updatePermission.immutableprops = ["_id", "owner", "status", "featured", "draft", "quality", "company", "deleted"]; // Define the properties that can't be updated by 'Verified' role
...
// Set delete permissions for the 'jobs' collection for the 'Verified' role
