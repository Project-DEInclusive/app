            ...
            <div className="mt-10">
                <div className="grid grid-cols-1 text-sm sm:grid-rows-1 sm:grid-cols-12 sm:gap-x-6mt-3 text-gray-500 md:gap-x-8 lg:gap-x-8">
                    ...
                    <div className="mt-6 sm:col-span-7 sm:mt-0 md:row-end-1">
                        ...
                        <h3 className="text-xl font-semibold text-gray-900 mt-4">Event Description</h3>
                        <p className="text-gray-500 mt-3 text-base">{event.description}</p>
                    </div>
                    <div className="sm:col-span-12 md:col-span-7">
                        <h3 className="text-xl font-semibold text-gray-900 mt-4">Event Article</h3>
                        <div className="text-gray-800 mt-6 text-base">{ReactHtmlParser(event.content)}</div>
                    </div>
                </div>
            </div>
        </main>
