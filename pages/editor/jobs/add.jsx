...
const Add = (props) => {
        ...
        if (_collections == null)
            _setCollections(
                await collectionfetcher.getCollections(
                    ["jobcategory", "jobtype", "jobworkplace", "jobseniority", "jobindustry", "jobexperiencelevel", "jobeducationlevel", "currencies", "countries"],
                    () => {}
                )
            );
    };
    ...
    const getQualityStatus = (quality) => {
        if (quality > 90) return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800"> Excellent </span>;
        if (quality > 80) return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800"> Good </span>;
        if (quality > 70) return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800"> Moderate </span>;
        return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800"> Not Good </span>;
    };
    ...
    return (
        <form className="space-y-8 divide-y divide-gray-200" onSubmit={handleSubmit} ref={pageRef}>
            <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <div className="max-w-lg flex justify-center pb-6 rounded-md">
                                    {dataObj.thumbnail && dataObj.thumbnail.src && (
                                        <img
                                            src={`${process.env.NEXT_PUBLIC_IMAGE_URL}${dataObj._id || "job"}${thumblstup}?key=${dataObj.thumbnail.src}`}
                                            alt="Job banner"
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <select
                                    id="vacent"
                                    name="vacent"
                                    className={getInputSytle(errors.vacent)}
                                    value={dataObj.vacent}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("vacent")}
                                >
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <select
                                    id="urgent"
                                    name="urgent"
                                    className={getInputSytle(errors.urgent)}
                                    value={dataObj.urgent}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("urgent")}
                                >
                                    <option defaultValue={""}>Select</option>
                                    <option value={true}>Yes</option>
                                    <option value={false}>No</option>
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="relative mt-1 sm:mt-0 sm:col-span-2">
                                <input
                                    ...
                                    id="candidatescount"
                                    min={1}
                                    className={getInputSytle(errors.candidatescount)}
                                    value={dataObj.candidatescount}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("candidatescount")}
                                />
                    ...
                    <div className="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <select
                                    ...
                                    className={getInputSytle(errors.jobtype)}
                                    value={dataObj.jobtype}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("jobtype")}
                                >
                                    <option selected disabled>
                                        Select Job Type
                                    </option>
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <select
                                    ...
                                    className={getInputSytle(errors.seniority)}
                                    value={dataObj.seniority}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("seniority")}
                                >
                                    <option selected disabled>
                                        Select Seniority
                                    </option>
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <select
                                    ...
                                    className={getInputSytle(errors.industry)}
                                    value={dataObj.industry}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("industry")}
                                >
                                    <option selected disabled>
                                        Select Industry
                                    </option>
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <select
                                    ...
                                    className={getInputSytle(errors.experience)}
                                    value={dataObj.experience}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("experience")}
                                >
                                    <option selected disabled>
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <select
                                    ...
                                    className={getInputSytle(errors.workplace)}
                                    value={dataObj.workplace}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("workplace")}
                                >
                                    <option selected disabled>
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <select
                                    ...
                                    className={getInputSytle(errors.education)}
                                    value={dataObj.education}
                                    onChange={handleChange}
                                    readOnly={getReadOnly("education")}
                                >
                                    <option selected disabled>
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 col-span-2">
                                <div className="relative rounded-md shadow-sm inline-flex w-full">
                                    <div className=" inset-y-0 left-0 flex items-center">
                                        ...
                                        <select
                                            ...
                                            autoComplete="salary.currency"
                                            className={getInputSytle(errors.salary?.currency) + " rounded-l-md rounded-r-none"}
                                            value={dataObj.salary?.currency}
                                            onChange={handleChange}
                                            readOnly={getReadOnly("salary.currency")}
                                        >
                                            <option selected disabled>
                                                Select Currency
                                            </option>
                                    ...
                                    <input
                                        ...
                                        name="salary.avarage"
                                        id="salary.avarage"
                                        autoComplete="salary.avarage"
                                        className={getInputSytle(errors.salary?.avarage) + "rounded-none"}
                                        value={dataObj.salary?.avarage}
                                        min={0.0}
                                        placeholder="0.00"
                                        step="0.01"
                                        onChange={handleChange}
                                        readOnly={getReadOnly("salary.avarage")}
                                    />
                                    <div className=" inset-y-0 right-0 flex items-center">
                                        ...
                                        <select
                                            name="salary.timeperiod"
                                            id="salary.timeperiod"
                                            autoComplete="salary.timeperiod"
                                            className={getInputSytle(errors.salary?.timeperiod) + " rounded-r-md rounded-l-none"}
                                            value={dataObj.salary?.timeperiod}
                                            onChange={handleChange}
                                            readOnly={getReadOnly("salary.timeperiod")}
                                        >
                ...
                <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    <div>
                        <h3 className="text-lg leading-6 font-medium text-gray-900">Work Place Information</h3>
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">This information will be displayed publicly so be careful what you share.</p>
                    </div>
